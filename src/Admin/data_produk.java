...
public class data_produk extends javax.swing.JPanel {
    ...
    try {
        ...
        Logging.saveLog("\n[" + tanggal + "] Berhasil menampilkan data produk ");
    } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        tbluser.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nama", "Price", "Category", "Available"
            }
        ));
    ...
    if (!keyword.isEmpty()) {
        ...
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy H:m:s z");
        String tanggal = sdf.format(d);
        Logging.saveLog("\n[" + tanggal + "] Berhasil mencari user " + keyword);
    } else {
    ...
    if (selectedRow == -1) {
        JOptionPane.showMessageDialog(null, "Pilih product yang ingin dihapus terlebih dahulu.");
        return;
    }
    ...
    int confirm = JOptionPane.showConfirmDialog(null, "Apakah Anda yakin ingin menghapus product ini?", "Konfirmasi Hapus", JOptionPane.YES_NO_OPTION);
    if (confirm == JOptionPane.YES_OPTION) {
        ...
        try {
            ...
            String query = "DELETE FROM menu_items WHERE item_id = '" + userId + "'";
            ...
            if (result > 0) {
                ...
                SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy H:m:s z");
                String tanggal = sdf.format(d);
                Logging.saveLog("\n[" + tanggal + "] Berhasil mencari user " + userId);
    ...
    public void refresh(){
        ...
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy H:m:s z");
        String tanggal = sdf.format(d);
        Logging.saveLog("\n[" + tanggal + "] Berhasil merefresh data produk ");
    }
}
